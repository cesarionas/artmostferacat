...
export interface Person { id: string; name: string; slug: string; description: string | null; status: Status; category_id: string | null; created_at: string; updated_at: string; category?: Category | null; images?: Image[]; files?: AssetFile[]; tags?: Tag[] }
